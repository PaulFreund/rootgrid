...
export function upsertAppSettings(db, { retentionDays, notifications, now = Date.now() }) {
  db.prepare(`
    INSERT INTO app_settings(
      singleton_id,
      retention_days,
      notifications_sse_toasts,
    ...
    ON CONFLICT(singleton_id) DO UPDATE SET
      ...
      notifications_sse_toasts=excluded.notifications_sse_toasts,
      notifications_web_push=excluded.notifications_web_push,
...
export function getAppSettings(db) {
  ...
  `).get()
  return appSettingsRowToRecord(row)
}
