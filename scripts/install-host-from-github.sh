...
export ROOTGRID_HOME_DIR ROOTGRID_RUNTIME_DIR ROOTGRID_INSTALL_DIR
CONFIG_PATH="$ROOTGRID_HOME_DIR/config.json"
...
echo "Managed runtime: $ROOTGRID_RUNTIME_DIR/current"
